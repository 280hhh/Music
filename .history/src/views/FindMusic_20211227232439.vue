    ...
    align="center"
     ...
     <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <span>
          <el-button class="el-icon-star-on" v-show="scope.row.love" @click="love(scope.row)" circle></el-button>
          <el-button class="el-icon-star-off" v-show="!scope.row.love" @click="love(scope.row)" circle></el-button>
        </span>
      </template>
    </el-table-column>
  </el-table>
