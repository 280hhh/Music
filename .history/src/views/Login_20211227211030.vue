<template>
    ...
    <div style="height:450px">
            <div class="userphoto"><img src="../assets/jr.jpg"></div>
            <!--表单部分-->
            <div class="form">
            <el-form ref="loginFormRef" :model="loginForm" label-width="80px" :rules="loginFormRules" >
            <el-form-item prop="username">
                <el-input placeholder="请输入用户名" prefix-icon="el-icon-user" v-model="loginForm.username" style="width:300px;"></el-input>
            </el-form-item>
            <el-form-item prop="password">
                ...
                <!-- <div><el-button @click="register()">点击注册</el-button></div> -->
                <el-dialog
                    width="30%"
                    title="内层 Dialog"
                ...
                <el-button type="primary" @click="innerVisible = true"><router-link to='/register'></router-link></el-button>
