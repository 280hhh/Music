...
<div class="FindMusic">
  <center>
      <div class="lunbo">
        <el-carousel :interval="5000" arrow="always" type="card" height="292px">
    ...
    align="center"
     ...
     <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <span>
          <el-button type="text" v-show="scope.row.love" @click="love(scope.row)" ><img src="@/assets/喜欢.png" style="width:20px;height:20px"></el-button>
          <el-button type="text" v-show="!scope.row.love" @click="love(scope.row)" ><img src="@/assets/未喜欢.png" style="width:20px;height:20px"></el-button>
        </span>
      </template>
    </el-table-column>
  </el-table>
