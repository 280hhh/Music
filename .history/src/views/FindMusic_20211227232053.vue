    ...
    align="center"
     ...
     <el-table-column
      ...
      <template slot-scope="scope">
        ...
        <span>
          <el-button type="text" v-show="scope.row.love" @click="love(scope.row)" ><i class="el-icon-star-on" style="font-size:30px;"/></el-button>
          <el-button type="text" v-show="!scope.row.love" @click="love(scope.row)" ><i class="el-icon-star-off" style="font-size:25px;"></el-button>
        </span>
      </template>
    </el-table-column>
  </el-table>
